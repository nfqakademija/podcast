 ...
 */
final class Version20191212201708 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE podcast CHANGE source_id source_id INT DEFAULT NULL, CHANGE image image VARCHAR(255) DEFAULT NULL, CHANGE audio audio VARCHAR(255) DEFAULT NULL, CHANGE video video VARCHAR(255) DEFAULT NULL, CHANGE type type VARCHAR(255) DEFAULT NULL, CHANGE slug slug VARCHAR(255) DEFAULT NULL');
        $this->addSql('CREATE INDEX idx_slug ON podcast (slug)');
        ...
        $this->addSql('CREATE INDEX idx_slug ON tag (slug)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX idx_slug ON podcast');
        ...
        $this->addSql('DROP INDEX idx_slug ON source');
        ...
        $this->addSql('DROP INDEX idx_slug ON tag');
